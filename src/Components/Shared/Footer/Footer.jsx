...
const Footer = () => {
    return (
        <footer className='bg-black text-[var(--text-primary)]'>
            <div className="footer p-10 border-b-2 border-[var(--text-primary)]">
                <aside>
                    <img className='w-[100px]' src={logo} alt="" />
                    <p>Alishan<br />Stone basin manufacturer since 2020</p>
                </aside>
                <nav>
            ...
            <div className="footer items-center p-4">
                <aside className="items-center grid-flow-col">
                    ...
                    <p>Copyright © 2023 - All right reserved by Alishan</p>
                </aside>
